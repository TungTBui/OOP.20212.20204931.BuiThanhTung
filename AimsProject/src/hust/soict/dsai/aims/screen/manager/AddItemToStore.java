...
import hust.soict.dsai.aims.screen.manager.StoreManagerScreen.MediaStore;
...
public class AddItemToStore extends JPanel{
                ...
                if (output == JOptionPane.YES_OPTION) {
                	if (checkMediaType() == 0){
                    	...
                    	if (cdOutput == JOptionPane.YES_OPTION) {
                    		sms.switchScreen(sms.getCurrentScreen(), addTrackPanel(addedCD, Integer.parseInt(textFields[4].getText())));
                    	}
	...
	public int checkMediaType() {
		if (this instanceof AddBookToStore) {
			return 0;
		}
		else if (this instanceof AddCompactDiscToStore) {
			return 1;
		}
		else if (this instanceof AddDigitalVideoDiscToStore) {
			return 2;
		}
		else {
			return -1;
